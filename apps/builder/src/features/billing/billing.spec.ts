...
test.beforeAll(async () => {
  ...
  await createProbots([{ id: usageProbotId, workspaceId: usageWorkspaceId }])
})
...
test('custom plans should work', async ({ page }) => {
  ...
  await page.goto('/probots?claimCustomPlan=true')
