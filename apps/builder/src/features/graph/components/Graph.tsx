...
import { DraggableBlockType, PublicProbot, Probot } from '@typebot.io/schemas'
...
export const Graph = ({
  ...
  const [graphPosition, setGraphPosition] = useState(
    graphPositionDefaultValue(
      probot.groups.at(0)?.graphCoordinates ?? { x: 0, y: 0 }
    )
  )
  ...
  const handleMouseUp = (e: MouseEvent) => {
    ...
    createGroup({
      ...
      indices: { groupIndex: probot.groups.length, blockIndex: 0 },
    })
