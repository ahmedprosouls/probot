...
import { hasDefaultConnector } from '@/features/probot/helpers/hasDefaultConnector'
...
export const BlockNode = ({
  ...
  const { probot, updateBlock } = useProbot()
  ...
  const hasIcomingEdge = probot?.edges.some((edge) => {
    ...
    >
      {(ref, isContextMenuOpened) => (
        ...
        >
          ...
          {probot && isMediaBubbleBlock(block) && (
