...
export const MetadataForm = ({
  ...
  return (
    <Stack spacing="6">
      ...
      <TextInput
        label="Title:"
        defaultValue={metadata.title ?? probotName}
      ...
      <TextInput
        ...
        moreInfoTooltip="Do not include it if you are embedding your probot in an existing website. GTM should be installed in the parent website instead."
      />
      <Stack>
