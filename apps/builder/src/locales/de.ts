export default {
  ...
  'folders.createProbotButton.label': 'Probot erstellen',
  ...
  'folders.probotButton.live': 'Live',
  'folders.probotButton.showMoreOptions': 'Mehr Optionen anzeigen',
  'folders.probotButton.unpublish': 'Veröffentlichung aufheben',
  'folders.probotButton.duplicate': 'Duplizieren',
  'folders.probotButton.delete': 'Löschen',
  'folders.probotButton.deleteConfirmationMessage':
    'Möchtest du deinen Probot {probotName} wirklich löschen?',
  'folders.probotButton.deleteConfirmationMessageWarning':
  ...
  'account.apiTokens.description':
    'Diese Token ermöglichen es anderen Apps, dein gesamtes Konto und Probots zu steuern. Sei vorsichtig!',
  ...
  'billing.contribution.preLink':
    'Probot trägt 1% deines Abonnements dazu bei, CO₂ aus der Atmosphäre zu entfernen.',
  ...
  'billing.usage.chats.alert.soonReach':
    'Deine Probots sind beliebt! Du wirst bald das Chat-Limit deines Tarifs erreichen. 🚀',
  ...
  'billing.usage.storage.alert.soonReach':
    'Deine Probots sind beliebt! Du wirst bald das Speicherlimit deines Tarifs erreichen. 🚀',
  ...
  'workspace.settings.deleteButton.confirmMessage':
    'Sind Sie sicher, dass Sie den Workspace {workspaceName} löschen möchten? Alle seine Ordner, Probots und Ergebnisse werden dauerhaft gelöscht.',
  ...
  'templates.buttons.heading': 'Erstelle einen neuen Probot',
  ...
  'templates.importFromFileButon.toastError.description':
    'Konnte die Datei nicht verarbeiten. Bist du sicher, dass es sich um einen Probot handelt?',
  ...
  'editor.sidebarBlock.probot.label': 'Probot',
  ...
  'editor.blockCard.logicBlock.tooltip.probotLink.label':
    'Verlinkung zu einem anderen Probot',
  ...
  'editor.blockCard.integrationBlock.tooltip.googleAnalytics.label':
    'Google Analytics',
  'editor.editableProbotName.tooltip.rename.label': 'Umbenennen',
  ...
  'editor.provider.messages.getProbotError.title':
    'Fehler beim Abrufen des Probots. Aktualisiere die Seite.',
  'editor.provider.messages.getProbotError.description':
    'Probot konnte nicht gefunden werden.',
  'editor.provider.messages.publishedProbotError.title':
    'Fehler beim Abrufen des veröffentlichten Probots',
  'editor.provider.messages.updateProbotError.title':
    'Fehler beim Aktualisieren des Probots',
