export default {
  ...
  'folders.createProbotButton.label': 'Create a probot',
  ...
  'folders.probotButton.showMoreOptions': 'Show more options',
  'folders.probotButton.unpublish': 'Unpublish',
  'folders.probotButton.duplicate': 'Duplicate',
  'folders.probotButton.delete': 'Delete',
  'folders.probotButton.deleteConfirmationMessage':
    'Are you sure you want to delete your probot {probotName}?',
  ...
  'account.apiTokens.description':
    'These tokens allow other apps to control your whole account and probots. Be careful!',
  ...
  'billing.contribution.preLink':
    'Probot is contributing 1% of your subscription to remove CO₂ from the atmosphere.',
  ...
  'billing.usage.chats.alert.soonReach':
    "Your probots are popular! You will soon reach your plan's chats limit. 🚀",
  ...
  'billing.usage.storage.alert.soonReach':
    "Your probots are popular! You will soon reach your plan's storage limit. 🚀",
  ...
  'workspace.settings.deleteButton.confirmMessage':
    'Are you sure you want to delete {workspaceName} workspace? All its folders, probots and results will be deleted forever.',
  ...
  'templates.buttons.heading': 'Create a new probot',
  ...
  'templates.importFromFileButon.toastError.description':
    "Failed to parse the file. Are you sure it's a probot?",
  ...
  'editor.blockCard.logicBlock.tooltip.probotLink.label':
    'Link and jump to another probot',
  ...
  'editor.blockCard.integrationBlock.tooltip.googleAnalytics.label':
    'Google Analytics',
  'editor.editableProbotName.tooltip.rename.label': 'Rename',
