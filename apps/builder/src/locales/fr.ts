export default {
  ...
  'folders.createProbotButton.label': 'Créer un probot',
  ...
  'folders.probotButton.showMoreOptions': "Afficher plus d'options",
  'folders.probotButton.unpublish': 'Dépublier',
  'folders.probotButton.duplicate': 'Dupliquer',
  'folders.probotButton.delete': 'Supprimer',
  'folders.probotButton.deleteConfirmationMessage':
    'Es-tu sûr de vouloir supprimer votre probot {probotName} ?',
  ...
  'account.apiTokens.description':
    "Ces tokens permettent à d'autres applications de contrôler ton compte et tes probots. Prudence !",
  ...
  'billing.contribution.preLink':
    "Probot contribue à hauteur de 1% de votre abonnement pour éliminer le CO₂ de l'atmosphère.",
  ...
  'billing.usage.chats.alert.soonReach':
    'Tes probots sont populaires ! Tu atteindras bientôt la limite de chats de votre abonnement. 🚀',
  ...
  'billing.usage.storage.alert.soonReach':
    'Tes probots sont populaires ! Tu atteindras bientôt la limite de stockage de ton abonnement. 🚀',
  ...
  'workspace.settings.deleteButton.confirmMessage':
    'Es-tu sûr(e) de vouloir supprimer le workspace {workspaceName} ? Tous ses dossiers, probots et résultats seront supprimés pour toujours.',
  ...
  'templates.buttons.heading': 'Créer un nouveau probot',
  ...
  'templates.importFromFileButon.toastError.description':
    "Échec de l'analyse du fichier. Es-tu sûr que c'est un probot ?",
  ...
  'editor.blockCard.logicBlock.tooltip.probotLink.label':
    'Lier et exécuter un autre probot',
  ...
  'editor.blockCard.integrationBlock.tooltip.googleAnalytics.label':
    'Google Analytics',
  'editor.editableProbotName.tooltip.rename.label': 'Renommer',
  ...
  'editor.provider.messages.getProbotError.title':
    'Erreur lors de la récupération du probot. Rafraîchissez la page.',
  'editor.provider.messages.getProbotError.description':
    'Impossible de trouver le probot.',
  'editor.provider.messages.publishedProbotError.title':
    'Erreur lors de la récupération du probot publié',
  'editor.provider.messages.updateProbotError.title':
    'Erreur lors de la mise à jour du probot',
