export default {
  ...
  'folders.probotButton.deleteConfirmationMessage':
    'Tem certeza de que deseja excluir seu probot {probotName}?',
  ...
  'account.apiTokens.description':
    'Esses tokens permitem que outros aplicativos controlem toda a sua conta e probots. Tenha cuidado!',
  ...
  'billing.contribution.preLink':
    'A Probot está contribuindo com 1% da sua assinatura para remover o CO₂ da atmosfera.',
  ...
  'billing.usage.chats.alert.soonReach':
    'Seus probots são populares! Você logo alcançará o limite de chats de seu plano. 🚀',
  ...
  'billing.usage.storage.alert.soonReach':
    'Seus probots são populares! Você logo alcançará o limite de armazenamento de seu plano. 🚀',
  ...
  'workspace.settings.deleteButton.confirmMessage':
    'Você tem certeza de que deseja excluir o espaço de trabalho {workspaceName}? Todas as suas pastas, probots e resultados serão excluídos permanentemente.',
  ...
  'templates.importFromFileButon.toastError.description':
    'Falha ao analisar o arquivo. Tem certeza de que é um probot?',
