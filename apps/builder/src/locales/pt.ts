export default {
  ...
  'dashboard.title': 'Os meus probots',
  delete: 'Apagar',
  ...
  'folders.createProbotButton.label': 'Criar um probot',
  ...
  'folders.probotButton.live': 'Ao Vivo',
  'folders.probotButton.showMoreOptions': 'Mostrar mais opções',
  'folders.probotButton.unpublish': 'Despublicar',
  'folders.probotButton.duplicate': 'Duplicar',
  'folders.probotButton.delete': 'Apagar',
  'folders.probotButton.deleteConfirmationMessage':
    'Tem a certeza de que deseja excluir o seu probot {probotName}?',
  ...
  'account.apiTokens.description':
    'Estes tokens permitem que outras aplicações controlem toda a sua conta e probots. Tenha cuidado!',
  ...
  'billing.contribution.preLink':
    'A Probot está a contribuir com 1% da sua subscrição para remover o CO₂ da atmosfera.',
  ...
  'billing.usage.chats.alert.soonReach':
    'Os seus probots são populares! Vai alcançar em breve o limite de chats do seu plano. 🚀',
  ...
  'billing.usage.storage.alert.soonReach':
    'Os seus probots são populares! Vai alcançar em breve o limite de armazenamento do seu plano. 🚀',
  ...
  'workspace.settings.deleteButton.confirmMessage':
    'Tem a certeza de que deseja eliminar o espaço de trabalho {workspaceName}? Todas as suas pastas, probots e resultados serão excluídos permanentemente.',
  ...
  'templates.buttons.heading': 'Criar um novo probot',
  ...
  'templates.importFromFileButon.toastError.description':
    'Falha ao analisar o ficheiro. Tem certeza de que é um probot?',
  ...
  'editor.blockCard.logicBlock.tooltip.probotLink.label':
    'Link e salte para outro probot',
  ...
  'editor.blockCard.integrationBlock.tooltip.googleAnalytics.label':
    'Google Analytics',
  'editor.editableProbotName.tooltip.rename.label': 'Renomear',
