...
import { ProbotProvider } from '@/features/editor/providers/ProbotProvider'
...
const App = ({ Component, pageProps }: AppProps) => {
  ...
  const probotId = query.probotId?.toString()
      ...
      <I18nProvider locale={pageProps.locale} fallbackLocale={en}>
        <ChakraProvider theme={customTheme}>
          <SessionProvider session={pageProps.session}>
            <UserProvider>
              <ProbotProvider probotId={probotId}>
                <WorkspaceProvider probotId={probotId}>
                  <Component {...pageProps} />
