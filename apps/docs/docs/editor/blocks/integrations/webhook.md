...
What I need in my case is instead of inserting "Star Wars", I'd like to insert a probot variable:
...
Feel free to ask the [community](https://www.facebook.com/groups/probot) for help if you struggle setting up a Webhook block.
