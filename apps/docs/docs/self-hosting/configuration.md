...
| NEXTAUTH_URL <Asterix/>              |         | The builder base URL. Should be the publicly accessible URL (i.e. `https://probot.domain.com`)                                                                                                                                             |
...
| NEXT_PUBLIC_ONBOARDING_probot_ID    |         | probot ID used for the onboarding. Onboarding page is skipped if not provided.                                                                                                                                                             |
...
| NEXT_PUBLIC_SMTP_FROM |         | From name and email (i.e. `'probot Notifications' <notifications@host.com>`)                                                                                                                                                                              |
...
Used for authenticating with GitHub. By default, it uses the credentials of a probot-dev app.
...
| S3_BUCKET               | probot | Name of the bucket where assets will be uploaded in.                               |
...
The [official probot managed service](https://app.probot.io/) uses other services such as [Stripe](https://stripe.com/) for processing payments, [Sentry](https://sentry.io/) for tracking bugs and [Sleekplan](https://sleekplan.com/) for user feedbacks.

The related environment variables are listed here but you are probably not interested in these if you self-host probot.
...
:::note
If you're self-hosting probot, [sponsoring me](https://github.com/sponsors/baptisteArno) is a great way to give back to the community and to contribute to the long-term sustainability of the project.
