        ...
        {block.items.map((item, idx) => (
          <span key={item.id} className="relative inline-flex ml-2 mb-2">
            <button
              ...
              className={
                'py-2 px-4 text-left font-semibold rounded-md transition-all filter hover:brightness-90 active:brightness-75 duration-100 focus:outline-none probot-button ' +
