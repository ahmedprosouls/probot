...
export const openIframe = (bubble: Element): void => {
  const iframe = bubble.querySelector('.probot-iframe') as HTMLIFrameElement
  loadProbotIfFirstOpen(iframe)
...
export const loadProbotIfFirstOpen = (iframe: HTMLIFrameElement): void => {
