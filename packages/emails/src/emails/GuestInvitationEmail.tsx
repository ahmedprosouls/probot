  ...
  <Mjml>
    ...
    <MjmlBody width={600}>
      <MjmlSection padding="0">
        <MjmlColumn>
          <HeroImage src="https://probot.s3.eu-west-3.amazonaws.com/assets/invitation-banner.png" />
        </MjmlColumn>
      </MjmlSection>
      <MjmlSection padding="0 24px" cssClass="smooth">
        <MjmlColumn>
          <Text>
            You have been invited by {hostEmail} to collaborate on his probot{' '}
            <strong>{probotName}</strong>.
          </Text>
          <Text>
            From now on you will see this probot in your dashboard under his
          ...
          <Button link={url}>Go to probot</Button>
        </MjmlColumn>
      </MjmlSection>
    </MjmlBody>
  </Mjml>
