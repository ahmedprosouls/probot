...
export const ConversationContainer = (props: Props) => {
  ...
  const [theme, setTheme] = createSignal(props.initialChatReply.probot.theme)
  ...
  createEffect(() => {
    setTheme(
      parseDynamicTheme(props.initialChatReply.probot.theme, dynamicTheme())
    )
  })
  ...
  return (
    <div
      ref={chatContainer}
      class="flex flex-col overflow-y-scroll w-full min-h-full px-3 pt-10 relative scrollable-container probot-chat-view scroll-smooth gap-2"
    >
      <For each={chatChunks()}>
        {(chatChunk, index) => (
          <ChatChunk
            ...
            theme={theme()}
            settings={props.initialChatReply.probot.settings}
