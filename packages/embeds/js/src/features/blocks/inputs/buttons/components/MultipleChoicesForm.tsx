          ...
          {(item) => (
            <span class={'relative' + (isMobile() ? ' w-full' : '')}>
              <div
                ...
                class={
                  'w-full py-2 px-4 font-semibold focus:outline-none cursor-pointer select-none probot-selectable' +
          ...
          {(selectedItemId) => (
            <span class={'relative' + (isMobile() ? ' w-full' : '')}>
              <div
                ...
                class={
                  'w-full py-2 px-4 font-semibold focus:outline-none cursor-pointer select-none probot-selectable selected'
                }
