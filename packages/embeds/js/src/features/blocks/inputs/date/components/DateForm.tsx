  ...
  return (
    <div class="flex flex-col">
      <div class="flex items-center">
        <form
          class={'flex justify-between probot-input pr-2 items-end'}
          onSubmit={(e) => {
        ...
        >
          <div class="flex flex-col">
            ...
            >
              ...
              <input
                class="focus:outline-none flex-1 w-full text-input probot-date-input"
                style={{
                  'min-height': '32px',
                  'min-width': '100px',
                  'font-size': '16px',
            ...
            {props.options?.isRange && (
              <div class="flex items-center p-4">
                ...
                <input
                  class="focus:outline-none flex-1 w-full text-input ml-2 probot-date-input"
                  style={{
                    'min-height': '32px',
                    'min-width': '100px',
                    'font-size': '16px',
