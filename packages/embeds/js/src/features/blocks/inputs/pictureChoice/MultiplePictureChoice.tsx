        ...
        <For each={filteredItems()}>
          {(item, index) => (
            <div
              ...
              class={
                'flex flex-col focus:outline-none cursor-pointer select-none probot-selectable-picture' +
        ...
        >
          {(selectedItem, index) => (
            <div
              ...
              class={
                'flex flex-col focus:outline-none cursor-pointer select-none probot-selectable-picture selected'
              }
