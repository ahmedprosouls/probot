...
const baseEnv = {
  ...
  client: {
    ...
    NEXT_PUBLIC_ONBOARDING_PROBOT_ID: z.string().min(1).optional(),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_ONBOARDING_PROBOT_ID: getRuntimeVariable(
      'NEXT_PUBLIC_ONBOARDING_PROBOT_ID'
    ),
...
const s3Env = {
  server: {
    ...
    S3_BUCKET: z.string().min(1).optional().default('probot'),
