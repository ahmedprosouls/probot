/*
  ...
  - A unique constraint covering the columns `[id,ownerId]` on the table `Probot` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Probot_id_ownerId_key" ON "Probot"("id", "ownerId");
