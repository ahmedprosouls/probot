/*
  ...
  - You are about to drop the column `ownerId` on the `Probot` table. All the data in the column will be lost.
...
-- DropForeignKey
ALTER TABLE "Probot" DROP CONSTRAINT "Probot_ownerId_fkey";
...
-- DropIndex
DROP INDEX "Probot_id_ownerId_key";
...
-- AlterTable
ALTER TABLE "Probot" DROP COLUMN "ownerId";
