/*
  ...
  - Made the column `workspaceId` on table `Probot` required. This step will fail if there are existing NULL values in that column.
...
-- AlterTable
ALTER TABLE "Probot" ALTER COLUMN "workspaceId" SET NOT NULL;
