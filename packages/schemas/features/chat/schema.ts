...
import { listVariableValue, probotSchema } from '../probot'
import {
...
export const startProbotSchema = z.preprocess(
  preprocessProbot,
...
const startParamsSchema = z.object({
  probot: startProbotSchema
    .or(z.string())
    .describe(
      'Either a Probot ID or a Probot object. If you provide a Probot object, it will be executed in preview mode. ([How can I find my probot ID?](https://docs.probot.io/api#how-to-find-my-probotid)).'
    ),
  isPreview: z
    .boolean()
    .optional()
  ...
  prefilledVariables: z
    ...
    .optional()
    .describe(
      '[More info about prefilled variables.](https://docs.probot.io/editor/variables#prefilled-variables)'
    ),
  isStreamEnabled: z
    .boolean()
    .optional()
...
export const chatReplySchema = z.object({
  ...
  probot: probotSchema._def.schema
...
export type StartProbot = z.infer<typeof startProbotSchema>
